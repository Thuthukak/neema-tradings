                  ...
                  createVNode("div", { class: "about-grid" }, [
                    ...
                    createVNode("div", { class: "about-content" }, [
                      ...
                      createVNode("p", { class: "about-text" }, [
                        ...
                        createTextVNode(", a qualified project manager, bid specialist and business developer, with years of experience in tender bidding and training, masters candidate. Neema Tradings is dedicated to simplifying the complex world of business compliance and development. With years of expertise in Central Supplier Database registration, company compliance, and tender processes, we've helped countless businesses unlock new opportunities and achieve sustainable growth. ")
                      ]),
                ...
                createVNode("div", { class: "container" }, [
                  ...
                  createVNode("div", { class: "services-grid" }, [
                    ...
                    createVNode("div", { class: "service-card" }, [
                      ...
                      createVNode("div", { class: "service-price" }, "R500"),
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "form-group" }, [
                          ...
                          withDirectives(createVNode("select", {
                            ...
                            createVNode("option", { value: "tender-admin-training" }, "Office Tender Administrator Training"),
                            createVNode("option", { value: "company-reinstatement" }, "Company Reinstatement"),
                            createVNode("option", { value: "company-profile" }, "Company Profile"),
                            createVNode("option", { value: "tax-pin" }, "Tax PIN"),
